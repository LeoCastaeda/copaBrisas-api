...
const createCustomer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const newCustomer = yield customerService.createCustomer({ name, phone, email });
...
const updateCustomer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const data = req.body;
        const updatedCustomer = yield customerService.updateCustomer(id, data);
...
const deleteCustomer = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        yield customerService.deleteCustomer(id);
        res.status(204).send();
    }
    catch (error) {
        res.status(404).json({ message: "Customer not found" });
